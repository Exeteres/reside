...
import { assertRepositoryRoot, exists } from "@reside/skill-reside-core/repository"
...
const usage =
  "Usage: bun .opencode/skills/reside-replica/src/scaffold-replica.ts <source-replica> <new-replica> [russian-title]"
...
async function main(): Promise<void> {
  ...
  console.log(
    "Next steps: adjust domain logic, register topology, run generators, then load reside-changes for version and changelog policy.",
  )
}
