...
В качестве библиотеки для взаимодействия с Telegram используется [grammy](https://grammy.dev/). Благодаря хелперу, реплики-потребители могут использовать весь функционал grammy для обработки событий из Telegram. Они могут вешать любые обработчики на `composer` и использовать любые свойства контекста. Но стоит
