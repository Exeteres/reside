...
Если вы по каким-то неведомым причинам захочет запустить свой кластер ReSide,
...
Есть также ряд опций для автоматическо создания локального Kubernetes-кластера с помощью Kind, смотрите `reside cluster bootstrap --help` для подробностей.
