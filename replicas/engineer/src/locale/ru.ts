export const ru = {
  ...
  reaper: {
    title: "Инженерная Реплика",
    actions: {
      deleteSourceCode: "Удаление исходного кода",
    },
    prompts: {
      deleteSourceCode: (replicaName: string) =>
        `Подготовь план удаления реплики ${replicaName} из исходного кода проекта. Удали пакет реплики, регистрацию в топологии, связанные зависимости, конфигурацию сборки и тесты, если они относятся только к этой реплике. Не выполняй реализацию без отдельного подтверждения плана.`,
    },
  },
}
