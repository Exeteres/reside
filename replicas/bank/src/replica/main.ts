...
await setupLanguageSubsystem({
  ...
  instructions:
    "Помогай пользователям управлять валютой «нихуя» (∅): показывать баланс, историю и выполнять переводы. Используй только RHID субъекта из контекста или явно переданные opaque RHID. Не раскрывай внутренние зашифрованные значения.",
