...
export interface QuotaFailure_Violation {
   ...
   * this field.
   */
  futureQuotaValue?: string | undefined;
}
  ...
  fromJSON(object: any): RetryInfo {
    return {
      retryDelay: isSet(object.retryDelay)
        ? Duration.fromJSON(object.retryDelay)
        : isSet(object.retry_delay)
        ? Duration.fromJSON(object.retry_delay)
        : undefined,
    };
  },
  ...
  fromJSON(object: any): DebugInfo {
    return {
      stackEntries: globalThis.Array.isArray(object?.stackEntries)
        ...
        : globalThis.Array.isArray(object?.stack_entries)
...
export const QuotaFailure_Violation: MessageFns<QuotaFailure_Violation> = {
  encode(message: QuotaFailure_Violation, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    globalThis.Object.entries(message.quotaDimensions).forEach(([key, value]: [string, string]) => {
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 7: {
          ...
          message.quotaValue = reader.int64().toString();
          continue;
        }
        case 8: {
          if (tag !== 64) {
          ...
          message.futureQuotaValue = reader.int64().toString();
          continue;
        }
      }
      if ((tag & 7) === 4 || tag === 0) {
  ...
  fromJSON(object: any): QuotaFailure_Violation {
    return {
      ...
      apiService: isSet(object.apiService)
        ? globalThis.String(object.apiService)
        : isSet(object.api_service)
        ? globalThis.String(object.api_service)
        : "",
      quotaMetric: isSet(object.quotaMetric)
        ? globalThis.String(object.quotaMetric)
        : isSet(object.quota_metric)
        ? globalThis.String(object.quota_metric)
        : "",
      quotaId: isSet(object.quotaId)
        ? globalThis.String(object.quotaId)
        : isSet(object.quota_id)
        ? globalThis.String(object.quota_id)
        : "",
      quotaDimensions: isObject(object.quotaDimensions)
        ? (globalThis.Object.entries(object.quotaDimensions) as [string, any][]).reduce(
          (acc: { [key: string]: string }, [key, value]: [string, any]) => {
            acc[key] = globalThis.String(value);
            return acc;
          },
        ...
        : isObject(object.quota_dimensions)
        ? (globalThis.Object.entries(object.quota_dimensions) as [string, any][]).reduce(
          (acc: { [key: string]: string }, [key, value]: [string, any]) => {
            acc[key] = globalThis.String(value);
            return acc;
          },
        ...
        : {},
      quotaValue: isSet(object.quotaValue)
        ? globalThis.String(object.quotaValue)
        : isSet(object.quota_value)
        ? globalThis.String(object.quota_value)
        : "0",
      futureQuotaValue: isSet(object.futureQuotaValue)
        ? globalThis.String(object.futureQuotaValue)
        : isSet(object.future_quota_value)
        ? globalThis.String(object.future_quota_value)
        : undefined,
    };
  },
  ...
  toJSON(message: QuotaFailure_Violation): unknown {
    ...
    if (message.quotaDimensions) {
      const entries = globalThis.Object.entries(message.quotaDimensions) as [string, string][];
      if (entries.length > 0) {
        obj.quotaDimensions = {};
        entries.forEach(([k, v]) => {
    ...
    if (message.quotaValue !== "0") {
      obj.quotaValue = message.quotaValue;
    }
    if (message.futureQuotaValue !== undefined) {
      obj.futureQuotaValue = message.futureQuotaValue;
    }
    return obj;
  },
  ...
  fromPartial(object: DeepPartial<QuotaFailure_Violation>): QuotaFailure_Violation {
    ...
    message.quotaDimensions = (globalThis.Object.entries(object.quotaDimensions ?? {}) as [string, string][]).reduce(
      (acc: { [key: string]: string }, [key, value]: [string, string]) => {
        if (value !== undefined) {
          acc[key] = globalThis.String(value);
        }
    ...
    message.quotaValue = object.quotaValue ?? "0";
    message.futureQuotaValue = object.futureQuotaValue ?? undefined;
    return message;
  },
};
  ...
  fromJSON(object: any): BadRequest_FieldViolation {
    return {
      ...
      localizedMessage: isSet(object.localizedMessage)
        ? LocalizedMessage.fromJSON(object.localizedMessage)
        : isSet(object.localized_message)
        ? LocalizedMessage.fromJSON(object.localized_message)
        : undefined,
    };
  },
  ...
  fromJSON(object: any): RequestInfo {
    return {
      requestId: isSet(object.requestId)
        ...
        : "",
      servingData: isSet(object.servingData)
        ? globalThis.String(object.servingData)
        : isSet(object.serving_data)
        ? globalThis.String(object.serving_data)
        : "",
    };
  },
